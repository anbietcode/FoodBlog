...
import banhdacua from '../imgs/banhdacua.jpg'


const BlogPostCard = ({ content, author , data }) => {
  ...
  return (
    ...
    <div className='w-full'>
        ...
        <div className='flex gap-4 mt-7'>
            ...
            <span className='ml-3 flex items-center gap-2 text-dark-grey'>
                <i className='fi fi-rr-heart tex-xl'></i>
                {total_likes}
            </span>
        </div>
    </div>
    ...
    <div className='h-28 aspect-square bg-grey'>
          <img src={banhdacua} alt=""  className='w-full h-full aspect-square object-cover'/>
    </div>
